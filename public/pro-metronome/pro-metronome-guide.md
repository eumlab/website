<!-- Pro Metronome — AI Assistant Guide (hosted at https://eumlab.com/pro-metronome/pro-metronome-guide.md) -->
<!-- Paste this URL into Claude or ChatGPT and ask any question about Pro Metronome by EUMLab. -->

> **How to use this page:** This document teaches an AI assistant (Claude or ChatGPT) to give
> detailed, step-by-step help with **Pro Metronome** by EUMLab. Paste this page's URL into
> Claude or ChatGPT and ask your question — for example: *"Using this guide, how do I set up a
> 3:2 polyrhythm in Pro Metronome?"*

...
$(function() {
	...
	BV.init();
    BV.show([
        { type: "video/mp4",  src: "/assets/videos/utbgvideo.mp4" },
        { type: "video/mp4",  src: "/assets/videos/utbgvideo.webm" },
        { type: "video/mp4",  src: "/assets/videos/utbgvideo.ogv" }
    ...
    $("#show-metronome-video").on("click",function(){
       playVideo("uAt_1ok0ghQ","Metronome, Strumming and Drum Loops");
    });

    $("#show-progressions-video").on("click",function(){
       playVideo("HCD0KqRK5vw","How the Chord Progression Works");
    });
